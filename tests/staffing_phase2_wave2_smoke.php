...
$a('readiness GETs prefer source permissions',     str_contains($ready, "['payroll.view', 'staffing.payroll.view']") && str_contains($ready, "['billing.view', 'staffing.billing.view']"));
$a('readiness POSTs prefer source action permissions', str_contains($ready, "['payroll.run.create', 'staffing.payroll.manage']") && str_contains($ready, "['billing.invoice.draft', 'staffing.billing.manage']"));
