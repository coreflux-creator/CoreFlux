...
$a('values GET uses platform record_id',       strpos($pd, 'custom_field_values.php?entity_type=people&record_id=') !== false);
$a('values POST endpoint',                     strpos($pd, "api.post(`/api/custom_field_values.php?entity_type=people&record_id=\${personId}`") !== false);
