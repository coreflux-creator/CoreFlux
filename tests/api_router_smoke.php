...
foreach ([
    'aging' => 'aging',
    'cash-cycle-health' => 'cash_cycle_health',
    'client-contacts' => 'client_contacts',
    'dunning' => 'dunning',
    'invoice-pdf' => 'invoice_pdf',
    'invoice-replay' => 'invoice_replay',
    'invoices' => 'invoices',
    'money-movement' => 'money_movement',
    'money-movement-archive' => 'money_movement_archive',
    'money-movement-pdf' => 'money_movement_pdf',
    'money-movement-share-links' => 'money_movement_share_links',
    'payments' => 'payments',
    'recurring-contracts' => 'recurring_contracts',
    'send-statement' => 'send_statement',
    'send-statements-batch' => 'send_statements_batch',
    'statement-pdf' => 'statement_pdf',
] as $route => $fileStem) {
    $file = apiRouterResolveFile('billing', $route);
    $assert("resolves billing/{$route} module endpoint",
        $file !== null && str_ends_with($file, "/modules/billing/api/{$fileStem}.php"));
}
