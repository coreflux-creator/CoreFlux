...
$a('uses shared CSV export service',          strpos($exc, 'Core\\CsvExportService') !== false);
$a('uses governed export datasets',           strpos($exc, 'exportDatasetFetchRows') !== false);
$a('handles type=bills',                      strpos($exc, "'bills' => [") !== false);
$a('bills CSV headers',                       strpos($exc, "'bill_number'") !== false && strpos($exc, "'vendor_name'") !== false && strpos($exc, "'total'") !== false);
$a('handles type=payments',                   strpos($exc, "'payments' => [") !== false);
$a('payments CSV headers',                    strpos($exc, "'pay_date'") !== false && strpos($exc, "'method'") !== false);
$a('handles type=expenses',                   strpos($exc, "'expenses' => [") !== false);
$a('expenses uses governed expenses dataset', strpos($exc, "'expenses'") !== false && strpos($exc, "'line_ids'") !== false);
