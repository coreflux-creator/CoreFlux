...
$assert('current census cannot promote an unapproved pay assignment',
    ($currentBillingOnlyContract['placement_status'] ?? '') === 'draft'
    && ($currentBillingOnlyContract['salary_lifecycle_enforced'] ?? null) === true);
