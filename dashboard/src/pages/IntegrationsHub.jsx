...
export default function IntegrationsHub() {
  ...
  const purepayStatus = purepay.loading
    ? 'loading'
    : purepay.data?.connected ? 'connected' : purepay.data?.configured ? 'not_connected' : 'not_configured';
      ...
      <Section title="Payment Rails">
        <ActionCardsGrid>
          ...
          <IntegrationCard
            ...
            icon={Banknote}
            title="Pure//Pay"
            description="Vendor bills and wallet payouts with signed settlement updates."
