...
| 2026-02-XX | **Plaid is the locked bank-integration provider** for the platform — covers statement import (Accounting bank rec), ACH origination (AP payments + Payroll DD), card import (AP), balance verification. Stripe ACH may be added as alternate path for tenants who opt in. All Phase B. | User chat (this fork) |
