...
ci_classify_lane() {
    ...
    case "$name" in
        ...
        ai_confidence_moat_*|ai_extract_*|ai_gateway_*|ui_polish_*|p1_linked_external_systems_*|\
        ...
        m365_graph_*|books_health_*|chart_of_accounts_*|company_directory_*|document_upload_*|people_search_*|\
