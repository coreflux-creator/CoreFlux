...
$values = [
    ...
    'QBO_RECAPTCHA_SITE_KEY' => trim((string) getenv('QBO_RECAPTCHA_SITE_KEY')),
    'QBO_RECAPTCHA_SECRET_KEY' => trim((string) getenv('QBO_RECAPTCHA_SECRET_KEY')),
    'QBO_RECAPTCHA_ALLOWED_HOSTS' => trim((string) (getenv('QBO_RECAPTCHA_ALLOWED_HOSTS') ?: 'corefluxapp.com,www.corefluxapp.com')),
