...
journal-entry approvals, Payroll run controls, and Treasury money movement
should use this writer instead of issuing direct `INSERT INTO audit_log`
statements. Domain-specific ledgers may still exist, but the platform audit row
is the cross-module evidence record.
