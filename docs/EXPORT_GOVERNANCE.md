...
People Directory, Placements, Time Entries, Payroll Disbursements, AP Payments,
AP Bills, AP Vendors, Expenses, Billing Invoices, and Billing Payments use this
shared runner for template exports. Raw legacy CSV endpoints may remain for
backward compatibility, but any new configurable export should be dataset and
template backed.
