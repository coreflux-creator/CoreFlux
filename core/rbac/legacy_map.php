...
final class RbacLegacyMap
{
    ...
    public static function table(): array
    {
        return [
            ...
            'accounting.je.void'                 => ['accounting', 'write'],
            ...
            'payroll.runs.view'                 => ['payroll', 'read'],
            ...
            'payroll.manage'                    => ['payroll', 'admin'],
            'payroll.runs.manage'               => ['payroll', 'write'],
            'payroll.schedules.manage'          => ['payroll', 'write'],
            'payroll.cycles.manage'             => ['payroll', 'write'],
            'payroll.profiles.manage'           => ['payroll', 'write'],
            'payroll.anomalies.acknowledge'     => ['payroll', 'write'],
            'payroll.deductions.manage'         => ['payroll', 'write'],
