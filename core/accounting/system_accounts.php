 ...
 *
 * The system chart includes the stable control accounts used by posting
 * rules plus the compact staffing revenue and direct-cost accounts used by
 * assignment-dimensional reporting.
 *
...
const ACCOUNTING_SYSTEM_ACCOUNTS = [
    ...
    ['code' => '1310', 'name' => 'Input Tax Receivable',       'type' => 'asset',     'side' => 'debit',  'subtype' => 'current_asset',     'section' => 'current_assets',     'sort' => 310],
    ...
    ['code' => '2100', 'name' => 'Sales Tax Payable',          'type' => 'liability','side' => 'credit', 'subtype' => 'current_liability', 'section' => 'current_liabilities','sort' => 200],
    ...
    ['code' => '4010', 'name' => 'Overtime Revenue',           'type' => 'revenue',   'side' => 'credit', 'subtype' => 'operating_revenue', 'section' => 'revenue',            'sort' => 110],
    ['code' => '4020', 'name' => 'Direct Hire Revenue',        'type' => 'revenue',   'side' => 'credit', 'subtype' => 'operating_revenue', 'section' => 'revenue',            'sort' => 120],
    ['code' => '4030', 'name' => 'Conversion Fee Revenue',     'type' => 'revenue',   'side' => 'credit', 'subtype' => 'operating_revenue', 'section' => 'revenue',            'sort' => 130],
    ['code' => '4040', 'name' => 'Reimbursed Expense Revenue', 'type' => 'revenue',   'side' => 'credit', 'subtype' => 'operating_revenue', 'section' => 'revenue',            'sort' => 140],
    ...
    ['code' => '5020', 'name' => 'Employer Payroll Tax Expense','type' => 'expense',  'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 120],
    ['code' => '5030', 'name' => 'FUTA Expense',               'type' => 'expense',   'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 130],
    ['code' => '5040', 'name' => 'SUTA Expense',               'type' => 'expense',   'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 140],
    ['code' => '5050', 'name' => 'Workers Compensation Expense','type' => 'expense', 'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 150],
    ['code' => '5060', 'name' => 'Worker Benefits Expense',    'type' => 'expense',   'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 160],
    ['code' => '5070', 'name' => 'Contractor Cost',            'type' => 'expense',   'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 170],
    ['code' => '5080', 'name' => 'Other Direct Placement Cost','type' => 'expense',   'side' => 'debit',  'subtype' => 'cogs',              'section' => 'cogs',               'sort' => 180],
...
function accountingSeedSystemAccounts(int $tenantId): array {
    ...
    $inserted = 0; $stamped = 0; $repaired = 0;
    $sel = $pdo->prepare(
    ...
    // Early versions assigned these two control-account names to the wrong
    // codes. Repair only the exact legacy system names; differently named
    // tenant accounts are left untouched.
    $repair = $pdo->prepare(
        'UPDATE accounting_accounts
            SET name = :new_name
          WHERE tenant_id = :tenant_id AND code = :code
            AND name = :old_name AND is_system_account = 1'
    );
    foreach ([
        ['2100', 'Payroll Liability', 'Sales Tax Payable'],
        ['2200', 'Sales Tax Payable', 'Payroll Payable'],
    ] as [$code, $oldName, $newName]) {
        $repair->execute([
            'tenant_id' => $tenantId,
            'code' => $code,
            'old_name' => $oldName,
    ...
    return [
        ...
        'stamped' => $stamped,
        'repaired' => $repaired,
        'total' => count(ACCOUNTING_SYSTEM_ACCOUNTS),
    ];
}
