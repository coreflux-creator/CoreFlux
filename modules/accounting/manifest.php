...
return [
    ...
    'permissions' => [
        ...
        'accounting.je.void'                    => 'Delete a journal entry from active books',
    ...
    'audit_events' => [
        ...
        'accounting.je.deleted',
        'accounting.je.corrected',
        ...
        'accounting.account.terms_updated',
        'accounting.account.interest_run',
        ...
        'accounting.intercompany.mapping_updated',
        ...
        'accounting.consolidation.relationship_created',
        'accounting.consolidation.relationship_updated',
        'accounting.consolidation.relationship_deactivated',
        'accounting.consolidation.run_locked',
        'accounting.consolidation.run_reversed',
        'accounting.consolidation.runs_auto_reversed',
