...
return [
    ...
    'permissions' => [
        ...
        'payroll.anomalies.detect'      => 'Run payroll anomaly detection',
        'payroll.anomalies.acknowledge' => 'Acknowledge AI anomaly findings',
        'payroll.settings.view'         => 'View tenant payroll settings',
        'payroll.settings.manage'       => 'Manage tenant payroll settings',
