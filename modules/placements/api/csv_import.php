...
CsvImportService::registerSchema('placements', [
    'fields' => [
        ...
        'bill_adder_pct'    => ['label' => 'Client bill adder %', 'type' => 'number'],
        'bill_adder_flat'   => ['label' => 'Client bill adder per unit', 'type' => 'number'],
        'bill_discount_pct' => ['label' => 'Client discount %', 'type' => 'number'],
...
function placementsCsvBuildRatePayload(array $row): ?array
{
    ...
    return [
        ...
        'bill_adder_pct' => placementsCsvPercentToDecimal($row['bill_adder_pct'] ?? null),
        'bill_adder_flat' => placementsCsvBlankToNull($row['bill_adder_flat'] ?? null),
        'bill_discount_pct' => placementsCsvPercentToDecimal($row['bill_discount_pct'] ?? null),
